...
NSString * const D3_MIN_URL = @"http://d3js.org/d3.v3.min.js";
...
NSString * const D3_BULLET_CHARTS = @"bulletCharts";
NSString * const D3_BOX_PLOTS = @"boxPlots";
NSString * const D3_SUNBURST = @"sunburst";
